...
public class IntegrationTests {
	...
	public static void setUpBeforeClass() throws Exception {
		my_dfa = (DFA) FA.parse_form_file("src/test/dfa1.dot");
		my_nfa = (NFA) FA.parse_form_file("src/test/nfa1.dot");
		my_nfalambda = (NFALambda) FA.parse_form_file("src/test/nfalambda1.dot");
	}
